...
[`CODING_RULES.md`](../../CODING_RULES.md) at the plugin root - that file is
the single source of truth. This skill exists to make the rules operational:
what to self-apply while writing code, and how to run the formatter afterward.

## 1. Read the rules first

Before writing or editing C code, read `CODING_RULES.md` in this plugin
...
`SKILL.md` location (two directories above its containing directory), then run
the bundled formatter script by absolute path:
